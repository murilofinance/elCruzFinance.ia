...
|------|-----|--------------|
| Primary | `#00E68A` | `--color-primary` |
| On Primary | `#04140C` | `--color-on-primary` |
| Secondary | `#7DFFC0` | `--color-secondary` |
| Accent/CTA | `#22FF99` | `--color-accent` |
| Background | `#05080D` | `--color-background` |
| Foreground | `#F4FFF8` | `--color-foreground` |
| Muted | `#0A1210` | `--color-muted` |
| Border | `rgba(34,255,153,0.22)` | `--color-border` |
| Destructive | `#FF5A5A` | `--color-destructive` |
| Ring | `#00E68A` | `--color-ring` |

**Color Notes:** Paleta extraída de `base front.jpg` — noite, neon verde, vidro escuro. Sem azul/roxo.
